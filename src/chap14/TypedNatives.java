...
public class TypedNatives extends Natives {
    ...
    protected void append(Environment env, String name, Class<?> clazz, String methodName, TypeInfo type, Class<?>...params) {
    ...
    protected void appendNatives(Environment env) {
        ...
        append(env, "length", chap14.java.length.class, "m", TypeInfo.function(TypeInfo.INT, TypeInfo.STRING), String.class);
